// CalcArrayRowColSum.cpp : This file contains the 'main' function. Program execution begins and ends there.
//

#include <iostream>

extern "C" int CalcArrayRowColSum(const int* x, int nrows, int ncols, int* row_sums, int* col_sum);
